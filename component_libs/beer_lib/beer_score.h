...
/*  Beer score array is as follows. (it's long)
    ...
    The third array level {5} does not pertain to this array.  Those are for cultivating the current
    score in total.  We'll store the current value of the beer in a size of [1] at the end.
--------------------------------------------------------------------------------------------
