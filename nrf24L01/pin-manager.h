...
typedef enum pin_max_e { SCK_MAX = 26, MISO_MAX, MOSI_MAX } pin_max_t;
 ...
 * 
 * @param mosi COPI pin number
 * @param miso CIPO pin number
 ...
 */
fn_status_t pin_manager_configure(uint8_t mosi, uint8_t miso, uint8_t sck, uint8_t csn, uint8_t ce);
